        ...
        <div className="gr">
          ...
          <div className="gi section-pad-sm">
            <div className="flex items-center gap-[var(--sp-3)] mb-[var(--sp-5)]">
              ...
              <span className="flex-1 divider-h" />
            </div>

            <Link
              href={`/blog/${featured.slug}`}
              className="group block border border-[var(--border)] bg-[var(--white)] transition-[border-color] duration-300 hover:border-[var(--border-mid)]"
            >
              <div className="grid md:grid-cols-[1fr_260px]">
                <div className="p-[var(--sp-5)] md:p-[var(--sp-6)] flex flex-col justify-between gap-[var(--sp-6)]">
                  <div>
                    ...
                    <h2 className="type-h2 mb-[var(--sp-4)] group-hover:text-[color:var(--emerald)] transition-colors duration-300">
                      {featured.title}
                    </h2>
                    <p className="type-body">{featured.description}</p>
                  </div>
                  <div className="flex items-center gap-[var(--sp-2)]">
                    <span className="type-label group-hover:text-[color:var(--ink)] transition-colors duration-200">Read article</span>
                    ...
                    {lanePosts.map((post) => (
                      ...
                      >
                        <div className="p-[var(--sp-4)] flex flex-col flex-1 gap-[var(--sp-3)]">
                          ...
                          <h3 className="type-h3 group-hover:text-[color:var(--emerald)] transition-colors duration-300">
                            {post.title}
                          </h3>
                        ...
                        <div className="border-t border-[var(--border)] px-[var(--sp-4)] py-[var(--sp-3)] flex items-center justify-between">
                          ...
                          <div className="flex items-center gap-1.5 text-[color:var(--ink-faint)] group-hover:text-[color:var(--ink)] transition-colors duration-200">
                            <span className="type-label">Read</span>
