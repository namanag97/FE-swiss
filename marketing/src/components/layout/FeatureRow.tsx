...
export function FeatureRow({ eyebrow, title, tagline, description, items, illustration, reverse }: FeatureRowProps) {
  return (
        ...
        <div className={`feature-row${reverse ? " feature-row--reverse" : ""}`}>
          {reverse ? (
            <>
              ...
              <FeatureContent eyebrow={eyebrow} title={title} tagline={tagline} description={description} items={items} />
            </>
          ) : (
            <>
              <FeatureContent eyebrow={eyebrow} title={title} tagline={tagline} description={description} items={items} />
...
function FeatureContent({ eyebrow, title, tagline, description, items }: Omit<FeatureRowProps, "illustration" | "reverse">) {
  return (
    <div>
