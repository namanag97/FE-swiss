...
Today we're launching Sancalana, a data platform built around a simple idea: your business processes are some of the most valuable data you have, and most teams still cannot see them clearly.

SQL can tell you the state of the business. It struggles to explain the flow of the business.
...
We're shipping fast. The near-term roadmap is focused on the work teams ask for after their first real process map:

| Feature | Timeline |
|---------|----------|
| AI-powered root cause analysis | Near term |
| Custom dashboards | Near term |
| Warehouse connectors (Snowflake, BigQuery) | In progress |
| Collaborative annotations | In progress |

Head to [the platform page](/platform) to learn more, or [request early access](/contact). Bring one messy process; we will map what is really happening.
